...
describe('total likes', () => {
  ...
  test('of bigger list equal all the likes summed', ()=> {
...
describe('favorite blog', () => {
  ...
  test('from list of one blog should be that blog', () => {
...
describe('most blogs', () => {
  ...
  test('from list of single author should return that author', () => {
    const result = listHelper.mostBlogs(listWithOneBlog)
    expect(result).toEqual({author: "Michael Chan", blogs: 1})
  })

  test('from empty list should return zero', () => {
...
describe('most likes', () => {
  ...
  test('has that blogger who is the only one on the list', () => {
